 ...
 * Shows "Add AED X to unlock Free Delivery" until the 200 AED threshold,
 * then a success state. Doubles as a progress meter.
 */
export function ShippingBanner() {
  ...
  return (
    <div className="bg-ink border-b border-gold/20 text-center text-sm">
      <div className="mx-auto max-w-5xl px-4 py-2">
        <p className="gold-text font-medium">
          {shipping.qualifies
            ? t("ship.unlocked")
            : t("ship.unlock", { amount: formatAED(shipping.remaining, locale === "ar" ? "ar-AE" : "en-AE") })}
        </p>
