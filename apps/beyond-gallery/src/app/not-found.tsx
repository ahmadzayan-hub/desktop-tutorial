...
export default function NotFound() {
  return (
    <div className="min-h-[70vh] flex flex-col items-center justify-center text-center px-6 bg-beyond-ivory text-beyond-charcoal font-bg-body">
      <link
        rel="stylesheet"
        href="https://fonts.googleapis.com/css2?family=Fraunces:opsz,wght@9..144,500..700&family=Inter:wght@400;500;600;700&display=swap"
      />
      <div className="beyond-divider mb-4">Beyond Gallery by GiftMajlis</div>
      ...
      <p className="mt-3 text-beyond-charcoal/70 max-w-md">
        ...
        message us on WhatsApp and we will point you to the right collection.
      </p>
