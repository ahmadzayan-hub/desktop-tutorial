...
export const TRANSLATIONS = {
  ...
  "brand.tagline":        { en: "From spark to boardroom-ready deck — in minutes.",
                            ar: "من الفكرة إلى عرضٍ جاهز لمجلس الإدارة، خلال دقائق." },
  ...
  "land.lede":            { en: "Pitchora is an AI agent studio that closes the gap between a half-formed idea and a polished deck: brand-governed, evidence-controlled, editable PPTX out, Arabic-RTL native, and scored on 10 boardroom dimensions — automatically.",
                            ar: "بِتشورا استوديو وكلاء ذكاء اصطناعي يسدّ الفجوة بين فكرةٍ في طور التشكّل وعرضٍ مصقول جاهز للعرض: حوكمة كاملة لهويّتك، تحقّق من الأدلّة، تصدير PPTX قابل للتحرير، دعم عربي أصيل من اليمين إلى اليسار، وتقييم تلقائي على عشرة أبعاد للجاهزية." },
  ...
  "feat.brand.body":      { en: "Logos, fonts, colors, terminology, density and tone enforced before any visual is rendered.",
                            ar: "الشعارات، الخطوط، الألوان، المصطلحات، الكثافة والنبرة — تُطبَّق آلياً قبل توليد أي عنصر مرئي." },
  ...
  "feat.evidence.body":   { en: "Every claim is classified — fact, assessment, estimate, or input required. We don't invent figures.",
                            ar: "كل عبارة مُصنَّفة: حقيقة، تقدير، تقييم، أو تحتاج مُدخلات. لا نختلق أرقاماً أبداً." },
  ...
  "foot.tagline":         { en: "Boardroom-ready presentations, generated by agents and governed by your brand.",
                            ar: "عروض جاهزة لمجلس الإدارة — تولّدها الوكلاء وتحكمها هويّتك المؤسّسية." },
