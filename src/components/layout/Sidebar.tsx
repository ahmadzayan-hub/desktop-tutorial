...
import {
  ...
  FolderOpen, MessageSquare, Calendar, Package, Bot, CreditCard, Flashlight,
  ClipboardList, Newspaper, HelpCircle, LogOut, Settings, ShieldCheck,
  ChevronRight, Zap, X, FileText
} from "lucide-react";
...
function NavLink({ href, icon, label, badge, onClose }: NavItem & { onClose?: () => void }) {
