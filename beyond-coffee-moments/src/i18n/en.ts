...
export const en = {
  ...
  customize: {
    ...
    message: {
      ...
      placeholder: "e.g. Happy anniversary, habibi ❤️",
    ...
    pay: {
      heading: "Payment",
      sub: "Pay securely now, or request a payment link on WhatsApp.",
      payNow: "Pay securely now",
      requestLink: "Request a WhatsApp payment link",
      methods: "Cards · Apple Pay · Google Pay · Tabby · Tamara · Cash on Delivery",
      secure: "256-bit encrypted · 3-D Secure",
      successTitle: "Your moment is on its way!",
      successSub: "Order {ref} confirmed. We've sent details to your WhatsApp. Our studio will share a design proof for approval.",
      linkSentTitle: "Payment link requested",
      linkSentSub: "We'll send a secure payment link for order {ref} to your WhatsApp shortly.",
