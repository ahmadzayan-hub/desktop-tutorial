  ...
  return (
    <div className="space-y-3">
      <p className="text-sm text-neutral-500">
        {locale === 'ar'
          ? 'الأسعار يدوية حالياً — التكامل مع أسعار السوق الحية جاهز مستقبلاً. حدّث الأسعار يومياً.'
          : 'Rates are manual today — live market API integration is future-ready. Update rates daily.'}
      </p>
