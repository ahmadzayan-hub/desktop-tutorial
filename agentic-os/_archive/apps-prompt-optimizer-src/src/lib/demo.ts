...
export const DEMO_ANNOUNCEMENTS = [
  ...
  { id: "a-03", user_id: "demo-user-001", course_id: "c-03", course_name: "Marketing Analytics",         title: "Guest speaker: Chief Marketing Officer from a Global Brand — Week 8", summary: "A leading CMO from a top global brand will deliver a live case study session. Attendance is mandatory.",                       risk_level: "low",    required_action: "Mark your calendar for Week 8 Thursday.",   is_archived: false, source: "instructor", created_at: d(-3) },
...
export const DEMO_TASKS = [
  ...
  { id: "t-03", user_id: "demo-user-001", title: "Create Marketing campaign outline",      description: "Digital campaign for an international tourism brand",       status: "in_progress", priority: "medium", course_id: "c-03", course_name: "Marketing Analytics",        due_date: d(3),  created_at: d(-1) },
...
export const DEMO_FILES = [
  ...
  { id: "f-03", user_id: "demo-user-001", course_id: "c-03", course_name: "Marketing Analytics",  file_name: "Digital_Marketing_Case_GlobalBrand.pdf",   file_type: "application/pdf", file_size: 1_700_000, processing_status: "ready", chunk_count: 31, created_at: d(-5) },
