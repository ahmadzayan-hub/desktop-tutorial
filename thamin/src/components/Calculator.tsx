...
const PRODUCT_TYPES = ['NECKLACE', 'BRACELET', 'RING', 'EARRINGS', 'PENDANT', 'CHAIN', 'ANKLET', 'BANGLE', 'HALF_SET', 'SET', 'OTHER'];
            ...
            <div className="space-y-2 text-sm">
              ...
              {estimate.confidence !== 'HIGH' && (
                <p className="rounded-lg bg-amber-50 p-2 text-amber-800">
                  {locale === 'ar'
                    ? 'مستوى الثقة متوسط أو منخفض، لذلك تلزم مراجعة بشرية قبل إرسال العرض للعميل.'
                    : 'Medium or low confidence, so human review is required before quoting a customer.'}
                </p>
              )}
              <div>
