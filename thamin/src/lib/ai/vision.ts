...
export const PhotoEstimateSchema = z.object({
  productType: z.enum([
    'NECKLACE', 'BRACELET', 'RING', 'EARRINGS', 'PENDANT', 'CHAIN', 'ANKLET', 'BANGLE', 'HALF_SET', 'SET', 'OTHER',
  ]),
...
{
  "productType": "NECKLACE|BRACELET|RING|EARRINGS|PENDANT|CHAIN|ANKLET|BANGLE|HALF_SET|SET|OTHER",
...
6. Arabic text must be natural, grammatically correct, business-friendly Modern Standard Arabic.
7. SAFE CLAIMS POLICY: descriptions must call items "fashion accessory" with "gold tone" or "silver tone" finishing. Never write "real gold", "real silver", "gold plated", "waterproof" or "anti-tarnish" in suggested titles or descriptions.`;
